...
namespace Acamti.Be.Fluent.With.Generics
{
    public static class ActExtensions
    {
        ...
        {
            await action(source.Clone(), p1, p2);
        ...
        {
            await action(source.Clone(), p1, p2, p3);
